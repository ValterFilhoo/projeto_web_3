...
@Component({
  ...
  imports: [HeaderComponent, BarraNavegacaoComponent, DetalhesPostagemComponent, BotaoCurtidaComponent, QtdComentariosComponent, ComentariosComponent, FooterComponent],
